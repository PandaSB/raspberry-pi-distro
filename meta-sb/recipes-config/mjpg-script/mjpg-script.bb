...
do_install() {
    ...
    #
    install -m 0755 ${WORKDIR}/mjpg_streamer  ${D}${sysconfdir}/init.d/
    ...
    #
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rcS.d/S99mjpg_streamer
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rc2.d/S99mjpg_streamer
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rc3.d/S99mjpg_streamer
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rc4.d/S99mjpg_streamer
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rc5.d/S99mjpg_streamer
    ln -sf ../init.d/mjpg_streamer  ${D}${sysconfdir}/rc1.d/K99mjpg_streamer
